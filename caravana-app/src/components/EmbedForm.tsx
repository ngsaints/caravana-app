...
export function EmbedForm() {
  ...
  return (
    <div className="embed-form-view">
      <div className="embed-form-container">
        <div className="embed-form-header">
          <h1>Cadastre sua Entidade Cultural</h1>
          <p>Faça parte do mapa cultural do Espírito Santo</p>
        </div>

        {success && (
          <div className="embed-success-message">
            <div className="success-icon">✓</div>
            <h3>Cadastro enviado com sucesso!</h3>
            <p>Sua entidade será analisada e em breve estará no mapa.</p>
          </div>
        )}

        {error && <div className="embed-error-message">{error}</div>}
        ...
        <form onSubmit={handleSubmit} className="embed-form">
          ...
          <p className="form-note">
            * Campos obrigatórios. Seu cadastro será analisado antes de ser publicado no mapa.
          </p>
        </form>

        <div className="embed-form-footer">
